...
<div class="item-3-wrapper">
  ...
  <table cellpadding="5" cellspacing="0" border="0" style="background-color:#fff">
    <tr>
      <td valign="top">
      <table class="item-3" width="100%" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td valign="top" rowspan="4"><div class="featured"> <img src="<?php print render($content['featured_session']['image']); ?>"/>
